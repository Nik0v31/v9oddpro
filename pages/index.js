...
const LEAGUES = [
  ...
  // 🇧🇪 België
  { id: 144, name: "Jupiler Pro League", flag: "🇧🇪" },
  // 🏴󠁧󠁢󠁥󠁮󠁧󠁿 Engeland lager
  { id: 40,  name: "Championship",     flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
  { id: 41,  name: "League One",       flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
  { id: 42,  name: "League Two",       flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
  // 🇪🇸 Spanje lager
  { id: 141, name: "La Liga 2",        flag: "🇪🇸" },
  // 🏆 Europese bekercompetities
  { id: 2,   name: "Champions League", flag: "⭐" },
  { id: 3,   name: "Europa League",    flag: "🟠" },
  { id: 848, name: "Conference League",flag: "🔵" },
  // 🏆 Nationale bekers
  { id: 45,  name: "FA Cup",           flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
  { id: 143, name: "Copa del Rey",     flag: "🇪🇸" },
  { id: 137, name: "Coppa Italia",     flag: "🇮🇹" },
  { id: 65,  name: "Coupe de France",  flag: "🇫🇷" },
  { id: 81,  name: "DFB Pokal",        flag: "🇩🇪" },
  { id: 90,  name: "KNVB Beker",       flag: "🇳🇱" },
  { id: 146, name: "Beker van België", flag: "🇧🇪" },
];
